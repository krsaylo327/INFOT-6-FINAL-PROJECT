...
if (count($_COOKIE) === 0) {
    ...
    header("location:http://localhost/todo/signup");
}
...
<body>
    <div class="row p-3">
        ...
        <div class="col s12 m4 p-6">
            <form action="/todo/create/account" method="post" id="signUp" class="row g-3">
    ...
    <script src="http://localhost/todo/js/signup.action.js" type="text/javascript"></script>
</body>
</html>